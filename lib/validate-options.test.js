...
describe("validateOptions", function() {
  ...
  context("when cssClass option is a string", function() {
    it("does not throw", function() {
      refute.exception(function() {
        validateOptions(
          getOptions({ cssClass: "4606ba15-0d09-4ce3-a507-36391788fe6f" })
        );
      });
    });
  });

  context("when cssClass option is undefined", function() {
    it("does not throw", function() {
      refute.exception(function() {
        validateOptions(getOptions({ cssClass: undefined }));
      });
    });
  });

  context(
    "when select option is not a String, and not `undefined`",
    function() {
      it("throws a TypeError", function() {
        const invalidOptions = getOptions({ cssClass: null });
        const expectedError = {
          name: "TypeError",
          message: "Expected cssClass option to be a string or undefined"
        };
